...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($check)) {
        ...
        header('location:backendwork/home.php');

    } else {
  
        echo "❌ Someting Wronge";
}
            ...
            <div
                ...
                <div
                    ...
                    <div class="text-center mb-6">
                        <h3 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-20">Login For Details</h3>
                        <br>
