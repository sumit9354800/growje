...
if (isset($_POST["submit"])) {
    ...
    // ✅ Yahan sirf escape add kiya gaya hai
    $description = mysqli_real_escape_string($conn, $_POST["description"]);
    $heading = mysqli_real_escape_string($conn, $_POST["heading"]);

    $insert = "INSERT INTO home(image,heading,description)
        VALUES ('$folder','$heading','$description')";
    ...
    <div class="min-h-screen">
        ...
        <aside id="sidebar"
            ...
            <nav class="px-4 py-4 space-y-2 text-sm">
                ...
                <a href="home.php" class="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-900 text-white">
                    <i class="bi bi-image"></i>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="text-center mb-6">
                                <h3 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Service Home</h3>
                                <p class="mt-1 text-sm text-gray-500">Upload banner image(409x230) with heading &
                                    description.
                                </p>
                            </div>

                            <form method="post" id="contactForm"
                                class="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                <button form="contactForm" name="submit" type="submit"
                                    class="relative w-full px-8 py-3 sm:py-4 text-sm sm:text-base font-semibold text-white rounded-full overflow-hidden group">
                                    <span
                                        ...
                                        <tr class="bg-white border-b border-gray-100">
                                            ...
                                            <td class="px-4 py-3 whitespace-nowrap">
                                                <a class="inline-block px-4 py-2 rounded-md bg-red-600 text-white text-xs sm:text-sm hover:bg-red-700"
                                                    href='delete/home-delete.php?id=<?= $fetch["id"] ?>'>Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php
