...
if (isset($_POST["submit"])) {
    ...
    $insert = "INSERT INTO detailshome(image,heading,description,item1,item2,item3)
        VALUES ('$folder','$heading','$description','$item1','$item2','$item3')";
    ...
    <div class="min-h-screen">
        ...
        <aside id="sidebar"
            ...
            <nav class="px-4 py-4 space-y-2 text-sm">
                <a href="details-home.php" class="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-900 text-white">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="text-center mb-6">
                                <h3 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Details Home</h3>
                                <p class="mt-1 text-sm text-gray-500">Upload banner image(282x283) with heading &
                                    description.</p>
                            </div>
                            ...
                            <form method="post" id="contactForm"
                                ...
                                <div class="relative group w-full lg:w-4/12 p-1">
                                    ...
                                    <input type="text" name="description" id="message"
                                        class="w-full pl-12 pr-4 py-3 sm:py-4 bg-white/60 rounded-xl border border-gray-300 text-sm sm:text-base text-gray-900 focus:ring-2 focus:ring-gray-900 focus:border-gray-900 outline-none transition-all duration-300 placeholder-gray-400 hover:bg-white/90"
                                ...
                                <div class="relative group w-full lg:w-4/12 p-1">
                                    <i
                                        class="bi bi-type absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-xl transition-all duration-300 group-focus-within:text-gray-900"></i>
                                    <input name="item1" type="text" id="heading"
                                        class="w-full pl-12 pr-4 py-3 sm:py-4 bg-white/60 rounded-xl border border-gray-300 text-sm sm:text-base text-gray-900 focus:ring-2 focus:ring-gray-900 focus:border-gray-900 outline-none transition-all duration-300 placeholder-gray-400 hover:bg-white/90"
                                        placeholder="item1...">
                                </div>
                                ...
                                <div class="relative group w-full lg:w-4/12 p-1">
                                    <i
                                        class="bi bi-type absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-xl transition-all duration-300 group-focus-within:text-gray-900"></i>
                                    <input name="item2" type="text" id="heading"
                                        class="w-full pl-12 pr-4 py-3 sm:py-4 bg-white/60 rounded-xl border border-gray-300 text-sm sm:text-base text-gray-900 focus:ring-2 focus:ring-gray-900 focus:border-gray-900 outline-none transition-all duration-300 placeholder-gray-400 hover:bg-white/90"
                                        placeholder="item2...">
                                </div>
                                ...
                                <div class="relative group w-full lg:w-4/12 p-1">
                                    <i
                                        class="bi bi-type absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-xl transition-all duration-300 group-focus-within:text-gray-900"></i>
                                    <input name="item3" type="text" id="heading"
                                        class="w-full pl-12 pr-4 py-3 sm:py-4 bg-white/60 rounded-xl border border-gray-300 text-sm sm:text-base text-gray-900 focus:ring-2 focus:ring-gray-900 focus:border-gray-900 outline-none transition-all duration-300 placeholder-gray-400 hover:bg-white/90"
                                        placeholder="item3...">
                                </div>
                            </form>
                            ...
                            <table class="w-full text-xs sm:text-sm text-left rtl:text-right text-gray-700">
                                <thead class="text-xs sm:text-sm bg-gray-100 border-b border-gray-200">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 font-medium whitespace-nowrap">item1</th>
                                        <th class="px-4 py-3 font-medium whitespace-nowrap">item2</th>
                                        <th class="px-4 py-3 font-medium whitespace-nowrap">item3</th>
                                ...
                                <?php
                                require_once('../conn.php');
                                $select = "SELECT * FROM detailshome";
                                        ...
                                        <tr class="bg-white border-b border-gray-100">
                                            ...
                                            <td class="px-4 py-3 whitespace-nowrap">
                                                <a class="inline-block px-4 py-2 rounded-md bg-red-600 text-white text-xs sm:text-sm hover:bg-red-700"
                                                    href='delete/details-home-delete.php?id=<?= $fetch["id"] ?>'>Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php
